...
export const PREVIEW_PRODUCTS: ProductDTO[] = [
  {
    ...
    type: 'product', isFeatured: true, imageUrl: '/products/chaussons-bouillotte-foyer.svg',
    images: ['/products/chaussons-bouillotte-foyer.svg', '/images/cat-chaleur.svg', '/images/hero-hiver.jpg'],
  ...
  },
  {
    ...
    type: 'product', isFeatured: true, imageUrl: '/products/housse-pare-brise-sentinelle.svg',
    images: ['/products/housse-pare-brise-sentinelle.svg', '/images/cat-auto.svg'],
  ...
  },
  {
    ...
    type: 'product', isFeatured: true, imageUrl: '/products/chaussettes-polaires-nuage.svg',
    images: ['/products/chaussettes-polaires-nuage.svg', '/images/cat-confort.svg'],
  ...
  },
  {
    ...
    type: 'product', isFeatured: true, imageUrl: '/products/plaid-sherpa-nid.svg',
    images: ['/products/plaid-sherpa-nid.svg', '/images/cat-maison.svg', '/images/hero-hiver.jpg'],
  ...
  },
  {
    ...
    type: 'product', isFeatured: false, imageUrl: '/products/cache-cou-polaire-bise.svg', images: ['/products/cache-cou-polaire-bise.svg'],
  ...
  },
  {
    ...
    type: 'product', isFeatured: false, imageUrl: '/products/gant-grattoir-polaire.svg', images: ['/products/gant-grattoir-polaire.svg'],
  ...
  },
  {
    ...
    type: 'product', isFeatured: false, imageUrl: '/products/chauffe-mains-reutilisables-braise.svg', images: ['/products/chauffe-mains-reutilisables-braise.svg'],
  ...
  },
  {
    ...
    type: 'bundle', isFeatured: false, imageUrl: '/products/pack-cocooning.svg', images: ['/products/pack-cocooning.svg'],
  ...
  },
  {
    ...
    type: 'bundle', isFeatured: false, imageUrl: '/products/pack-grand-froid.svg', images: ['/products/pack-grand-froid.svg'],
