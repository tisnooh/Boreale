...
import { matchesShopSeason, type Season, type ShopSeason } from '@/lib/season/types';

const WINTER: Season = 'winter';

export const PREVIEW_CATEGORIES: CategoryDTO[] = [
  { id: 'c1', slug: 'confort-textile', name: 'Confort & Textile', tagline: 'La première ligne contre le froid', description: 'Chaussettes polaires, gants tactiles, bonnets, cache-cous et leggings thermiques.', imageUrl: '/images/cat-confort.svg', season: WINTER, productCount: 5 },
  { id: 'c2', slug: 'chaleur', name: 'Chaleur', tagline: 'La chaleur, sans électricité', description: 'Bouillottes sèches, chauffe-mains réutilisables et chaussons bouillotte.', imageUrl: '/images/cat-chaleur.svg', season: WINTER, productCount: 3 },
  { id: 'c3', slug: 'auto-hiver', name: 'Auto Hiver', tagline: 'Rouler serein par tous les temps', description: 'Housse pare-brise antigivre et gant grattoir.', imageUrl: '/images/cat-auto.svg', season: WINTER, productCount: 2 },
  { id: 'c4', slug: 'maison-cocooning', name: 'Maison / Cocooning', tagline: 'Le refuge parfait', description: 'Plaids sherpa, plaids à manches et bouillottes.', imageUrl: '/images/cat-maison.svg', season: WINTER, productCount: 4 },
];
...
export const PREVIEW_PRODUCTS: ProductDTO[] = [
  {
    ...
    type: 'product', season: WINTER, isFeatured: true, imageUrl: '/images/products/chaussons-bouillotte-foyer.jpg',
  ...
  },
  {
    ...
    type: 'product', season: WINTER, isFeatured: true, imageUrl: '/images/products/housse-pare-brise-sentinelle.jpg',
  ...
  },
  {
    ...
    type: 'product', season: WINTER, isFeatured: true, imageUrl: '/images/products/chaussettes-polaires-nuage.jpg',
  ...
  },
  {
    ...
    type: 'product', season: WINTER, isFeatured: true, imageUrl: '/images/products/plaid-sherpa-nid.jpg',
  ...
  },
  {
    ...
    type: 'product', season: WINTER, isFeatured: false, imageUrl: '/images/products/cache-cou-polaire-bise.jpg', images: ['/images/products/cache-cou-polaire-bise.jpg'],
  ...
  },
  {
    ...
    type: 'product', season: WINTER, isFeatured: false, imageUrl: '/images/products/gant-grattoir-polaire.jpg', images: ['/images/products/gant-grattoir-polaire.jpg'],
  ...
  },
  {
    ...
    type: 'product', season: WINTER, isFeatured: false, imageUrl: '/images/products/chauffe-mains-reutilisables-braise.jpg', images: ['/images/products/chauffe-mains-reutilisables-braise.jpg'],
  ...
  },
  {
    ...
    type: 'product', season: WINTER, isFeatured: false, imageUrl: '/products/bouillotte-noyaux-cerise-brasero.svg', images: ['/products/bouillotte-noyaux-cerise-brasero.svg'],
  ...
  },
  {
    ...
    type: 'product', season: WINTER, isFeatured: false, imageUrl: '/products/plaid-manches-cocon.svg', images: ['/products/plaid-manches-cocon.svg'],
  ...
  },
  {
    ...
    type: 'bundle', season: WINTER, isFeatured: false, imageUrl: '/images/products/pack-cocooning.jpg', images: ['/images/products/pack-cocooning.jpg'],
  ...
  },
  {
    ...
    type: 'bundle', season: WINTER, isFeatured: false, imageUrl: '/images/products/pack-grand-froid.jpg', images: ['/images/products/pack-grand-froid.jpg'],
